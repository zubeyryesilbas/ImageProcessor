...
{
    public class PixelMagicEditor : EditorWindow
    {
        ...
        [MenuItem("Window/Pixel Magic Editor")]
        public static void ShowWindow()
        {
            GetWindow<PixelMagicEditor>("Pixel Magic Editor");
        }

        private void OnGUI()
        {  
            GUILayout.BeginHorizontal(EditorStyles.helpBox);
            GUILayout.Label("Pixel Magic Editor", EditorStyles.boldLabel );
