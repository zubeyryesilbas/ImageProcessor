    ...
    public class PixerEditor : EditorWindow
    {
        ...
        {  
           ...
           /* if(_currentProcess == ProcessTypes.GenerateGradient)
            ...
            GUILayout.EndHorizontal(); ;
            _scrollPosition2 = GUILayout.BeginScrollView(_scrollPosition2, GUILayout.Height(200f));
        ...
        {
            _gradient = EditorGUILayout.GradientField("Alpha Gradient", _gradient);
        ...
        {   
            ...
            _floatVal3 = EditorGUILayout.FloatField(_floatVal3, "Shadow Trancperency");
            GUILayout.EndHorizontal();
        ...
        {   
            ...
            if (!_boolVal)
            {
              ...
              /*  var length = Mathf.RoundToInt(Mathf.Sqrt(_colorsInPalette.Count));
                ...
                {   
                    ...
                    for (var  j = 0; j <length; j++)
                    {
                        ...
                        if(index >= _colorsInPalette.Count)
                            break;
                        
                        var item = _activeColorPalette[index];
                        EditorGUILayout.ColorField(item ,GUILayout.Width(50) , GUILayout.Height(50));
                    }
                    GUILayout.EndHorizontal();
